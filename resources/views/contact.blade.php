...
<body>
                    ...
                    <div class="contact-list-inner">
                        <div class="media">
                            ...
                            <div class="media-body align-self-center">
                                <h5>Email</h5>
                                <p>ukkimujahidin.student.uny.ac.id</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="contact-list-inner">
                        <div class="media">
                            ...
                            <div class="media-body align-self-center">
                                <h5>Alamat</h5>
                                <p>Gedung Student Center UNY lantai 2 Sayap, Barat Kampus Karangmalang, Yogyakarta</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="section-title mb-0">
                        ...
                        <ul class="social-media style-base pt-3">
                            ...
                            <li>
                                <a href="https://www.youtube.com/@ukkijamuny7209"><i class="fa fa-youtube" aria-hidden="true"></i></a>
                            </li>
                            <li>
                                <a href="https://www.instagram.com/ukkimujahidin_uny/"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7906.311671989524!2d110.37537029357907!3d-7.773294800000006!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a59b60c9c923f%3A0x490af909f1079297!2sStudent%20and%20Multicultural%20Center%2C%20State%20University%20of%20Yogyakarta!5e0!3m2!1sen!2sid!4v1730440422276!5m2!1sen!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
    <!-- contact area end -->
